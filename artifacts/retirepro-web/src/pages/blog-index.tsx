...
const POSTS = [
  ...
  },
  {
    ...
    excerpt: "UPS is live since April 2025. Compare all three pension schemes on guaranteed income, contributions, family pension, inflation protection — with clear guidance on who should pick what.",
    readTime: "13 min read",
    tag: "Government Pension",
    tagColor: "bg-slate-100 text-slate-700",
    gradient: "from-slate-800 to-amber-950",
    date: "22 Jul 2026",
    dateTime: "2026-07-22",
  },
  {
    ...
    excerpt: "₹1 crore? ₹5 crore? ₹10 crore? There is no universal number — but there is a formula. Here's how to calculate yours, with real examples and the 5 mistakes that destroy most plans.",
    readTime: "11 min read",
    tag: "Retirement Basics",
    tagColor: "bg-orange-100 text-orange-700",
  ...
  },
  {
    ...
    excerpt: "No EPF, no employer, no pension. Every rupee of your retirement must be consciously created by you. NPS, PPF, APY, SIPs — and the corpus calculation most business owners never do.",
  ...
  },
  {
    ...
    title: "NPS Withdrawal Rules 2026: The New 80:20 Rule, Exit at 15 Years, and Staying Invested Till 85",
    excerpt: "PFRDA has overhauled NPS exits so substantially that it's almost a different product. Understand the new 80% lump sum rule, corpus slabs, SLW, and the tax fine print nobody mentions.",
    readTime: "13 min read",
    tag: "NPS Guide",
    tagColor: "bg-amber-100 text-amber-700",
